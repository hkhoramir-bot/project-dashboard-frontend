// src/pages/Projects/CreateProjectPage.tsx (اصلاح شده)
...
const CreateProjectPage: React.FC = () => {
    const [formData, setFormData] = useState({
        name: '',
        description: '',
        startDate: '', // تاریخ‌ها به صورت رشته (YYYY-MM-DD) باقی می‌مانند
        endDate: '',
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // ✅ ارسال داده‌ها به صورت رشته تاریخ، نه آبجکت Date
        const projectData = {
            name: formData.name,
        ...
        try {
            ...
            // ✅ هندلینگ بهتر خطا
            const apiMessage = err.response?.data?.message || 'خطا در ارتباط با سرور. مطمئن شوید مسیر و متد POST در بک‌اند درست است.';
        ...
        <div className="p-8 bg-gray-100 min-h-full font-sans rtl" dir="rtl">
            <div className="max-w-4xl mx-auto bg-white p-10 rounded-3xl shadow-2xl border border-gray-200">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {error && <div className="p-4 bg-red-100 text-red-700 rounded-xl text-sm border border-red-200">{error}</div>}
